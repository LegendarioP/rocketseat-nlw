    ...
    return (
        ...
        className="flex flex-1 flex-col gap-2"> 
                <div className="flex items-center gap-4">
                    <label htmlFor="imgUpload" className="flex cursor-pointer items-center gap-1.5 text-sm text-gray-200 hover:text-gray-100">
                ...
                <button type="submit" className='bg-green-500 self-end text-black text-sm px-5 py-3 rounded-full font-alt font-bold inline-block leading-none'>SALVAR</button>
        </form>
    )
}