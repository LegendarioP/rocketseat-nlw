...
export default function NewMemory(){
    ...
    async function openImagePicker() {
        try {
            ...
            console.log("deu algum erro aq mas ne")
        }
    } 
    ...
    return (
        <ScrollView className="flex-1 px-8" contentContainerStyle={{ paddingBottom: bottom, paddingTop: top }}>
            ...
            <View className="mt-6 space-y-6">
                ...
                <TouchableOpacity activeOpacity={0.7} onPress={handleCreateMemory} className='rounded-full self-end bg-green-500 px-5 py-2 items-center'>
